...
namespace Proyect.Controllers
{
    public class RolesPermisosController : Controller
    {
        ...
        {
            var proyectContext = _context.PermisosRoles.Include(r => r.IdPermisoNavigation).Include(r => r.IdRolNavigation);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var rolesPermiso = await _context.PermisosRoles
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var rolesPermiso = await _context.PermisosRoles.FindAsync(id);
            if (rolesPermiso == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (rolesPermiso != null)
            {
                _context.PermisosRoles.Remove(rolesPermiso);
            }
        ...
        {
            return _context.PermisosRoles.Any(e => e.IdRolPermiso == id);
        }
    }
}
