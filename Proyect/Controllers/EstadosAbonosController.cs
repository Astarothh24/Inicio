...
namespace Proyect.Controllers
{
    public class EstadosAbonosController : Controller
    {
        ...
        {
            return View(await _context.Abonos.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var estadosAbono = await _context.Abonos
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var estadosAbono = await _context.Abonos.FindAsync(id);
            if (estadosAbono == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (estadosAbono != null)
            {
                _context.Abonos.Remove(estadosAbono);
            }
