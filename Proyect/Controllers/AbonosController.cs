...
namespace Proyect.Controllers
{
    public class AbonosController : Controller
    {
        ...
        public IActionResult Create(int idReserva)
        {
            ...
            ViewData["IdEstadoAbono"] = new SelectList(_context.Abonos, "IdEstadoAbono", "Nombre");
            ...
            IFormFile comprobanteFile)
        {
            ...
            ViewData["IdEstadoAbono"] = new SelectList(_context.Abonos, "IdEstadoAbono", "Nombre", abono.IdAbono);
            return View(abono);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["IdEstadoAbono"] = new SelectList(_context.Abonos, "IdEstadoAbono", "IdEstadoAbono", abono.IdAbono);
